...
const Category = () => {
  ...
  return (
    <div className='w-full'>
      <div className='w-full h-[60vh] sm:h-[60vh] md:h-[70vh] lg:h-[60vh] relative rounded-3xl' >
      ...
      <div className='w-full flex items-center justify-center flex-col my-5'>
        <h1 className='text-3xl md:text-5xl font-bold capitalize leading-normal py-5 overflow-hidden'>{categoryData?.data?.attributes?.title} products</h1>
